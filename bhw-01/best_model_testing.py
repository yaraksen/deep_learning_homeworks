...
def train_classifier(num_epochs, lr, batch_size, checkpoint=None):
    ...
    train_dataset = TrainValDataset(img_dir_path='../dl/bhw1-dataset/trainval/',
                                    csv_file_path='../dl/bhw1-dataset/labels.csv',
                                    train=True,
                                    val_size=0.25,
                                    transform=train_transform)

    val_dataset = TrainValDataset(img_dir_path='../dl/bhw1-dataset/trainval/',
                                  csv_file_path='../dl/bhw1-dataset/labels.csv',
                                  train=False,
                                  val_size=0.25,
...
if __name__ == '__main__':
    ...
    CUDA = int(input('enter cuda number:'))
    train_classifier(num_epochs=90, lr=0.5, batch_size=32, checkpoint='model_acc0.57956[2022-12-12 22-55-03.951463].pth')
